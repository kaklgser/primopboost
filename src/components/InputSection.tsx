...
interface InputSectionProps {
  ...
  displaySections?: 'resumeOnly' | 'jobDescriptionOnly' | 'all';
}
...
export const InputSection: React.FC<InputSectionProps> = ({
  ...
  const showResume = displaySections === 'resumeOnly' || displaySections === 'all';
  const showJD = displaySections === 'jobDescriptionOnly' || displaySections === 'all';

  return (
    <div className="space-y-4 lg:space-y-6 p-3 sm:p-4 lg:p-6 bg-white rounded-xl border border-gray-200">
      {showResume && (
