...
import { X, Plus, Briefcase, Code, Award, AlertCircle, CheckCircle, Calendar, Building, Phone, Mail, Link, Github } from 'lucide-react';
...
     <div className="text-center mb-4 sm:mb-6 mt-0 sm:mt-2"> {/* MODIFIED LINE */}
...
    >
      <div
        className="bg-white rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-[95vw] sm:max-w-4xl overflow-y-auto h-full flex flex-col" // Combined and simplified classes
      >
        {/* Header */}
...
        {/* Progress Bar */}
        <div className="px-3 sm:px-6 pt-3 sm:pt-6 flex-shrink-0"> {/* MODIFIED LINE */}
          <div className="flex flex-row items-center justify-center gap-4 sm:gap-6 mb-2 sm:mb-6"> {/* MODIFIED LINE */}
            {missingSections.map((section, index) => (
              <div key={section} className="flex items-center w-auto"> {/* MODIFIED LINE */}
                <div
...
                  <div className="w-5 h-px bg-gray-300 mx-2 sm:w-8 sm:h-1 sm:mx-4"></div> {/* MODIFIED LINE */}
                )}
              </div>
            ))}
          </div>
...
        {/* Content */}
        <div className="p-3 sm:p-6 flex-1"> {/* MODIFIED LINE: Removed overflow-y-auto and min-h-0 */}
...
        {/* Footer */}
        <div className="bg-gray-50 p-3 sm:p-6 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0"> {/* MODIFIED LINE: Removed flex-shrink-0 and min-h-0 */}
